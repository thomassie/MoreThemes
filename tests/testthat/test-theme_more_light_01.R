test_that("theme_more_light_01 returns a theme object", {
  theme <- theme_more_light_01()
  expect_s3_class(theme, "theme")
  expect_s3_class(theme, "gg")
})

test_that("theme_more_light_01 works with ggplot", {
  library(ggplot2)
...
test_that("edge cases are handled", {
  ...
  expect_no_error(theme_more_light_01(base_size = 1))
  expect_no_error(theme_more_light_01(base_size = 100))

  # Test with empty string for font family
  expect_no_error(theme_more_light_01(base_family = ""))

  # Test with unusual colors
  expect_no_error(theme_more_light_01(
    grid_color = "#FF0000",
